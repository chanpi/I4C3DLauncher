========================================================================
    Win32 アプリケーション: I4C3DLauncher プロジェクトの概要
========================================================================

この I4C3DLauncher アプリケーションは、AppWizard により作成されました。

このファイルには、I4C3DLauncher 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


I4C3DLauncher.vcxproj
...
I4C3DLauncher.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル I4C3DLauncher.rc 
    にインクルードされます。

I4C3DLauncher.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル I4C3DLauncher.rc 
    にインクルードされます。
